...
`213` skills, `55` O*NET categories, substrate `embedding`.
...
Probe rows where the similarity score is exactly identical across variants. This identifies when the category suffix is doing all the work.

| comparison | identical pairs |
|---|---|
| onet_vs_override | Docker↔Kubernetes, GitHub↔GitLab, MySQL↔PostgreSQL, Apache Spark↔Apache Hadoop |
